...
VALUES ('last_organizing_group', '', 'The group that organized the last event')
...
COMMENT ON COLUMN users.group_name IS 'The group this member belongs to for rotating event organization duties';
COMMENT ON COLUMN events.organizing_group IS 'The group responsible for organizing this event';
